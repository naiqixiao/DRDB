...
--
-- Host: localhost    Database: DRDBBackup
-- ------------------------------------------------------
...
CREATE TABLE `Appointment` (
  ...
  CONSTRAINT `FK_Family` FOREIGN KEY (`FK_Family`) REFERENCES `Family` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `Child` (
  ...
  `Sex` enum('F','M') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DoB` date DEFAULT NULL,
  `Age` int DEFAULT NULL,
  `Language` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `IdWithinFamily` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `HomeLanguage` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SchoolLanguage` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `School` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Gestation` decimal(2,0) DEFAULT NULL,
  `RecruitmentMethod` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ExperimenterAssignment` (
  ...
  CONSTRAINT `FK_Experimenter` FOREIGN KEY (`FK_Experimenter`) REFERENCES `Personnel` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Family` (
  `id` int NOT NULL AUTO_INCREMENT,
  `NamePrimary` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NameSecondary` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `CellPhone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RacePrimary` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `RaceSecondary` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `LanguagePrimary` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `LanguageSecondary` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `NextContactNote` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `RecruitmentMethod` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `AssignedLab_idx` (`AssignedLab`),
...
CREATE TABLE `Feedback` (
  ...
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CurrentPage` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `Lab` (
  `id` int NOT NULL AUTO_INCREMENT,
  `LabName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `PI` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Email` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `EmailOpening` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `EmailClosing` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `Location` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `TransportationInstructions` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `ZoomLink` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TYEmail` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `Personnel` (
  ...
  `Initial` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Role` enum('Admin','PostDoc','PI','GradStudent','Undergrad','RA','Lab manager','Staff') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `Calendar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `Schedule` (
  ...
  `Status` enum('Confirmed','TBD','Rescheduling','Rescheduled','No Show','Cancelled','Rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Reminded` int NOT NULL DEFAULT '0',
  `ThankYouEmail` int NOT NULL DEFAULT '0',
  `Note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `ScheduledBy` int NOT NULL,
  `FK_Family` int NOT NULL,
  `eventURL` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `calendarEventId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  KEY `_idx` (`FK_Family`),
  CONSTRAINT `Schedule_ibfk_4` FOREIGN KEY (`ScheduledBy`) REFERENCES `Personnel` (`id`),
  CONSTRAINT `Schedule_ibfk_5` FOREIGN KEY (`FK_Family`) REFERENCES `Family` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SecondExperimenterAssignment` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `FK_Appointment_2nd` (`FK_Appointment`),
  KEY `FK_Test` (`FK_Experimenter`),
...
CREATE TABLE `Study` (
  `id` int NOT NULL AUTO_INCREMENT,
  `StudyName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `MinAge` decimal(5,2) NOT NULL,
  `MaxAge` decimal(5,2) NOT NULL,
  `Description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `PhoneScript` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `EmailTemplate` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Completed` int NOT NULL DEFAULT '0',
  `FK_Lab` int NOT NULL,
  `FK_Personnel` int NOT NULL,
  `FK_TestingRoom` int DEFAULT NULL,
  `StudyType` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ASDParticipant` enum('Include','Exclude','Only') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Include',
  `PrematureParticipant` enum('Include','Exclude','Only') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Include',
  `VisionLossParticipant` enum('Include','Exclude','Only') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Include',
  `HearingLossParticipant` enum('Include','Exclude','Only') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Include',
  `IllParticipant` enum('Include','Exclude','Only') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Include',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ReminderTemplate` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `FollowUPEmailSnippet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `FK_Lab` (`FK_Lab`),
  KEY `Personnel_ibfk_3_idx` (`FK_Personnel`),
...
--
-- Table structure for table `TestingRoom`
--
...
CREATE TABLE `TestingRoom` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_Lab` (`FK_Lab`),
  CONSTRAINT `TestingRoom_ibfk_1` FOREIGN KEY (`FK_Lab`) REFERENCES `Lab` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2026-02-24 21:23:37
