    ...
    <v-row justify="center" align="center" style="height: 800px">
      ...
      <v-col cols="12" md="3">
        ...
        <div class="text-center" v-if="error">
          <br />
          <v-btn rounded color="primary" large @click="resetPassword" :disabled="!email"
      ...
      <v-col cols="12" lg="12">
        <h3>
          ...
          <a href="https://mcmaster-baby-lab.github.io/handbook/DRDB"
            target='_blank' >this site to learn some basics.</a
          >
        </h3>
      </v-col>
      <v-col cols="12" lg="12" class="d-flex align-center justify-center">
        <v-card
          outlined
          elevation="3"
          style="height: 462px; overflow-y: scroll !important"
        >
          ...
          <v-card-actions>
            <v-row justify="space-between" style="height: 50px">
              ...
              <v-col md="2">
                <v-btn
                  color="primary"
                  :disabled="passwordConfirmationRule != true || newPassword == null"
